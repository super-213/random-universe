...
| 远未来 | 最后一颗普通恒星熄灭、白矮星碰撞、质子衰变时代、星系引力蒸发、流浪黑洞掠过、霍金末期爆发、最后可探测信号 | 仅在渐近热寂分支生成，并按白矮星/黑洞宿主和远未来时间窗口裁剪 |

黑矮星超新星尚未放入默认日程：当前热寂时间轴在最后黑洞蒸发附近停止给出物理年份，不能诚实表示约 `10^1100` 年量级的高度推测事件。若后续增加“超远未来指数时间轴”，它适合作为该分支的首个事件。
