...
- **文明编年史与观测者模式**：点击任意文明可查看其完整因果事件链、生命演化与能源等级；切换到该文明的视角后，只显示已经进入其真实空间光锥的信息。
...
- **舰队级跨星系航行**：舰队保存目标、距离、速度、人口、补给、进度与抵达时间，可能抵达、途中分化、失联或返航；星系群视图按进度移动信标。
- **声音、性能与无障碍**：可主动开启低干扰程序化环境声；文明推演默认运行在 Web Worker，渲染使用稳定的 WebGL 路径；另提供高对比度、色盲配色、键盘选星和因果图文本描述。
...
行为参数之外，每个时间单位还会更新六项内部状态：人口受承载力与资源供给约束；资源随疆域、地球化、人口消耗和战争压力变化；能源由技术与巨构提供；治理受合作倾向、凝聚力和冲突影响；科研由技术底座、能源与先驱知识推动；稳定度综合资源、治理、能源、凝聚力、战争和信息污染。内部状态会反过来影响扩张能力、技术增长与长期生存，而不再只是文明条目的展示数字。
...
| **跨星系迁徙** | 星系桥殖民地或星系际流浪社会 | 把文明扩张范围推进到母星系引力边界之外，并改变凝聚力与可见度 |
| **黑洞能源文明** | 吸积盘采能、旋转能提取或霍金辐射收集 | 建立第三阶能源基础设施；失稳时造成大范围疆域损伤 |
| **母宇宙逃逸工程** | 人造婴儿宇宙、真空工程、时空捷径或因果闭环计算 | 成功时进入母宇宙外存续状态，失败时付出技术与疆域代价 |

文明快照记录人口、物质、能源、算力、生物承载力、物流吞吐、治理、科研、稳定度、技术树、可见度、凝聚力、机器自治、方舟、巨构、提升、地球化、数字载体、先驱知识、信息感染、相对论分支、过滤器、迁徙、恒星工程、跨星系定居、外域人口、黑洞能源、母宇宙逃逸、文明形态、能源等级、遗产、信号延迟和因果响应状态。所有分支在宇宙生成时预计算，因此来回拖动时间轴仍会得到相同历史。
...
局部星系群由当前种子独立生成 4–6 个伴星系。跨星系舰队具有速度、人口、补给、距离、预计抵达时间与确定性结局；三维星系群视图会连接母星系与目标星系，并让信标沿实际进度移动。文明在母星系内的物质、能源与计算运输则以低亮度物流线显示。
...
| 点击“以此文明观察” | 进入有限光锥视角，隐藏尚未抵达该文明的信息 |
| 点击“查看局部星系群” | 拉远到伴星系地图，查看跨星系人口与航线 |
| 切换“时间线 / 因果图” | 浏览线性历史，或缩放、拖动并点击因果节点跳转 |
| 点击“比较邻近宇宙” | 对照当前种子与三个确定性变体 |
| 保存时刻 / 复制链接 / 导出历史 | 在本机收藏观察点、分享当前种子与时间、导出文明 JSON |
| 点击恒星 | 在可观测阶段查看恒星样本信息 |
| 星图获得焦点后按 `←` / `→`、`Enter` | 切换可见恒星并读取详情 |
| 展开“观察设置” | 开启程序化声音、高对比或色盲配色；菜单默认收起以保持星图无遮挡 |
| 按 `Esc` | 依次收起比较面板、文明编年史、文明面板，或返回创世界面 |
...
- Web Worker 与 Web Audio API：后台文明推演和无采样资源的程序化声音
