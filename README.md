...
- **文明内部模型与技术树**：人口、资源、能源、治理、科研和社会稳定度随疆域、外交与灾变共同演化；技术按前置条件从行星工业推进到宇宙逃逸，并支付资源与稳定成本。
...
文明快照记录人口、资源、能源储备、治理、科研、稳定度、技术树、可见度、凝聚力、机器自治、方舟、巨构、提升、地球化、数字载体、先驱知识、信息感染、相对论分支、过滤器、迁徙、恒星工程、跨星系定居、外域人口、黑洞能源、母宇宙逃逸、文明形态、能源等级、遗产、信号延迟和因果响应状态。所有分支在宇宙生成时预计算，因此来回拖动时间轴仍会得到相同历史。
...
局部星系群由当前种子独立生成 4–6 个伴星系。跨星系迁徙成功后，模拟会为文明保存目标伴星系、外域人口及其增长状态；三维星系群视图会连接母星系与目标星系，并随时间轴重建航线是否已经存在。
