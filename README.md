...
文明快照记录技术、可见度、凝聚力、机器自治、方舟、巨构、提升、地球化、数字载体、先驱知识、信息感染、相对论分支、过滤器、迁徙、恒星工程、跨星系定居、黑洞能源、母宇宙逃逸、文明形态、能源等级、遗产、信号延迟和因果响应状态。所有分支在宇宙生成时预计算，因此来回拖动时间轴仍会得到相同历史。
...
文明编年史会把主体事件、接触事件和继承关系汇总到同一条可跳转时间线。能源阶梯从行星能源、恒星能源、黑洞能源推进到熵管理；“观察者模式”则根据文明母星与事件目标的实际三维距离、当前光速倍率和事件发生时刻计算信息抵达时间，而不是让全星系即时共享消息。
