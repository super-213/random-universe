...
- **文明演化**：5–15 个初始文明样本在 720 个宜居节点上殖民、接触、结盟、冲突、受灾和衰亡，并可能产生分裂继承者、提升物种或相对论迟归者。
...
文明快照记录技术、可见度、凝聚力、机器自治、方舟、巨构、提升、地球化、数字载体、先驱知识、信息感染、相对论分支和撤离状态。所有分支在宇宙生成时预计算，因此来回拖动时间轴仍会得到相同历史。
...
- 文明数量、外交、战争、灾后恢复、十二类文明事件与高维转化属于启发式或科幻层，不能用于推断现实生命概率；伴星系近掠则是压缩后的天体演化模型。
