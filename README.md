...
- **整个可观测宇宙**：从当前星系连续拉远到由 12,000 个代表性星系、超星系团、纤维与空洞构成的确定性宇宙网；所有结构会随宇宙时间形成、熄灭并响应最终结局。
...
局部星系群由当前种子独立生成 4–6 个伴星系。跨星系舰队具有速度、人口、补给、距离、预计抵达时间与确定性结局；伴星系和航线仍保留完整模拟。选择“查看整个宇宙”后，当前星系与局部群会缩小为宇宙网中的一个已标记节点，外围展示 12,000 个代表性星系以及确定性的超星系团、主纤维和空洞。文明在母星系内的物质、能源与计算运输仍以低亮度物流线显示。
